    ...
    <div class="container header-container d-flex flex-column flex-md-row justify-content-between">
      ...
      <div class="header-menu-container">
        ...
        <div class="header-menu">
            <?=Html::a((!empty(Yii::$app->user->identity->user_name)) ? 'Logout ('.Yii::$app->user->identity->user_name.')' : 'Logout ('.Yii::$app->user->identity->user_email.')', array('/user/logout'), array('class'=>'header-menu-login'))?>
